...
import static org.apache.flink.metrics.fmq.FmqReporterOptions.BOOTSTRAP_SERVERS;
import static org.apache.flink.metrics.fmq.FmqReporterOptions.CURRENT_SITE;
import static org.apache.flink.metrics.fmq.FmqReporterOptions.GROUPING_KEY;
import static org.apache.flink.metrics.fmq.FmqReporterOptions.JOB_ID;
import static org.apache.flink.metrics.fmq.FmqReporterOptions.JOB_NAME;
import static org.apache.flink.metrics.fmq.FmqReporterOptions.RANDOM_JOB_NAME_SUFFIX;
import static org.apache.flink.metrics.fmq.FmqReporterOptions.TOPIC;

/** fmq reporter factory. */
public class FmqReporterFactory implements MetricReporterFactory {
    ...
    public FmqReporter createMetricReporter(Properties properties) {
        ...
        Map<String, String> groupingKey =
                parseGroupingKey(FmqReporterOptions.getString(metricConfig, GROUPING_KEY));
        ...
        LOGGER.info(
                "Configured FmqReporter with {bootstrapServers:{}, topic:{}, currentSite:{}, jobName:{}, randomJobNameSuffix:{}, groupingKey:{}}",
                bootstrapServers,
                topic,
                currentSite,
                jobName,
                randomSuffix,
                groupingKey);
        return new FmqReporter(
                bootstrapServers, topic, currentSite, configuredJobId, jobName, groupingKey);
    }
