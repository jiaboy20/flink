...
/** Options for configuring the FmqReporter. */
...
public class FmqReporterOptions {
    ...
    public static final ConfigOption<String> BOOTSTRAP_SERVERS =
            ConfigOptions.key("bootstrapServers")
                    .stringType()
                    .noDefaultValue()
    ...
    public static final ConfigOption<String> CURRENT_SITE =
            ConfigOptions.key("currentSite")
                    .stringType()
                    .noDefaultValue()
